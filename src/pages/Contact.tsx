...
const Contact = () => {
  ...
  const eventTypes = [
    {
      id: "jason-xie/15-minutes-chat-with-me",
      title: "15 Min Chat",
      description: "Quick chat",
      duration: "15 min"
    },
    {
      id: "jason-xie/30-minutes-chat-with-me", 
      title: "30 Min Chat",
      description: "Standard meeting",
      duration: "30 min"
    },
    {
      id: "jason-xie/60-minutes-chat-with-me",
      title: "60 Min Chat", 
      ...
      <FadeInSection delay={0.2}>
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <motion.a
              href="mailto:xjason0312@gmail.com"
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 truncate">xjason0312@gmail.com</p>
              </div>
            </motion.a>
            ...
            <motion.a
              href="https://www.linkedin.com/in/jasonxie0312/"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center space-x-3 p-3 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 transition-all group"
              variants={cardHoverVariants}
